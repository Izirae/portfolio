...
export default function Contact({ data }) {
  ...
  return (
    <section id="contacto" className="relative py-24 px-6 max-w-6xl mx-auto overflow-hidden">
      {/* Aurora de fondo */}
      <Aurora />
        ...
        <div className="text-center mb-12">
          ...
          <div className="mt-8 mb-4">
            <a
              ...
              className="relative overflow-hidden inline-flex items-center gap-3 text-base font-bold px-8 py-4 rounded-2xl text-white transition-all hover:scale-105 active:scale-95 glow-brand"
