export const portfolioData = {
  ...
  projects: [
    ...
    { id:3,  title:"Portal de Tasas",                    desc:"Plataforma para consulta de deuda y generación de boletas para pago mediante Pago Fácil o Rapipago, o pago online por MercadoPago, Provincia.Net o Epagos de todas las tasas del municipio. Doble autenticación: empleados y ciudadanos.", type:"Full Stack", category:"municipal", stack:["Laravel","Blade","SQL Server","Provincia.Net","Mercado Pago","Epagos"], color:"#3dd68c", live:"https://apps.moron.gob.ar/portal_tasas" },
    ...
    { id:8,  title:"Dolarines — Monitor USDT/ARS",       desc:"Bot multi-usuario TypeScript: monitorea USDT/ARS en Binance y notifica por Telegram, Email y WhatsApp con análisis de mercado y clima.",            type:"Bot",            category:"personal",  stack:["TypeScript","Node.js","Telegram","Twilio","Binance","SQLite"],color:"#b07ef7", live:"https://t.me/DolarinBinBot" },
