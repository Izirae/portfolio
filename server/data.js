export const portfolioData = {
  ...
  projects: [
    { id:1,  title:"API Gateway Municipal",               desc:"API REST Laravel que centraliza RAFAM, expedientes, personas, RRHH y GIS con autenticación dual LDAP + JWT.",                                      type:"Microservicios", category:"municipal", stack:["Laravel","PHP","JWT","LDAP","SQL Server","MySQL"],         color:"#f76f6f" },
