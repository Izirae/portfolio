export const portfolioData = {
  ...
  projects: [
    { id:1,  title:"API Gateway Municipal",               desc:"API REST Laravel que centraliza RAFAM, expedientes, personas, RRHH y GIS con autenticación dual LDAP + JWT.",                                      type:"Microservicios", category:"municipal", stack:["Laravel","PHP","JWT","LDAP","SQL Server","Oracle"],        color:"#f76f6f" },
    { id:2,  title:"API Facturador Municipal",            desc:"Microservicio Lumen para emisión y consulta de facturas municipales por número, sistema, clave o CUIT.",                                           type:"API",            category:"municipal", stack:["Lumen","PHP","SQL Server","REST API"],                      color:"#f7b155" },
    { id:3,  title:"Portal de Tasas y Débito",           desc:"Plataforma para consulta de deuda, adhesión al débito automático bancario y pago online. Doble autenticación: empleados y ciudadanos.",             type:"Full Stack",     category:"municipal", stack:["Laravel","Blade","SQL Server","Mercado Pago"],             color:"#3dd68c" },
    { id:4,  title:"Portal de Proveedores",              desc:"Autogestión de proveedores municipales: alta, validación CUIT, actualización de email con token, adjuntos y consulta de pagos.",                    type:"Full Stack",     category:"municipal", stack:["Laravel","PHP","SQL Server","Token Email"],                color:"#38c5d9" },
